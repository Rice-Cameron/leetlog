...
try {
  ...
  if (config.mode === 'production') {
    console.log('   ⚠️  Production mode detected - destructive operations will require confirmation')
  } else {
    console.log('   ℹ️  Non-production mode - appropriate safety measures in place')
  }
